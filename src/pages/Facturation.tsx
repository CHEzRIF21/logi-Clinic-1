...
function TabPanel(props: TabPanelProps) {
  ...
  return (
    <div
      role="tabpanel"
      hidden={value !== index}
      id={`facturation-tabpanel-${index}`}
      aria-labelledby={`facturation-tab-${index}`}
      {...other}
    >
      ...
      <Box sx={{ py: 4 }}>
        ...
        <ToolbarBits sx={{ mb: 3 }}>
          <Box display="flex" alignItems="center" gap={2}>
            ...
            <Box>
              <GradientText variant="h4">Module Facturation</GradientText>
              <Typography variant="body2" color="text.secondary">
                Gestion complète du cycle financier : factures, paiements, crédits et rapports
              </Typography>
            </Box>
          </Box>
        </ToolbarBits>
